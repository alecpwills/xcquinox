...
# (25 until 2026-09-16, when the deck was restructured into 37 main and 8 backup frames; the
# rows below carry the new pages: 3 -> 5, 4 -> 6, 5 -> 7 and 8, 6 -> 9, 7 -> 10, 8 -> 11,
# 9 -> 12 and 13, 11 -> 15, 12 -> 16, 15 -> 21, 16 -> 22 and 23, 19 -> 27).
FRAME_COUNT = 45
