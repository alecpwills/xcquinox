...
\begin{frame}{Scope}
  ...
  \vspace{0.3em}
  \begin{itemize}
    \item Subset sizes 1, 2, 3, 4, 5, 6, 7, 12, 15, 18, 26 points of the 26-point DFS pool [DFS21, SI Sec. II], chosen by Jensen-Shannon selection (Sec. 2). 64 cells in the figures; two evaluated cells (deep\_attn\_2x8 at 18, deep\_3x16 [25 cycles] at 15) are excluded pending re-evaluation (Sec. 5).
...
\codenote{k\_F, s and the density floor (exchange network) [xcquinox/alec/networks.py:319--324]}{slides_code/p3_1_k_f_s_and_the_density_floor_exchange_net.txt}
\codenote{r\_s, k\_F, s (correlation network) [xcquinox/alec/networks.py:589--597]}{slides_code/p3_2_r_s_k_f_s_correlation_network.txt}
\codenote{the DFS coordinates x\_0, x\_1, x\_s (correlation network) [xcquinox/alec/networks.py:626--654]}{slides_code/p3_3_the_dfs_coordinates_x_0_x_1_x_s_correlat.txt}
\codenote{the exchange coordinate x\_s [xcquinox/alec/networks.py:341--352]}{slides_code/p3_4_the_exchange_coordinate_x_s.txt}
\codenote{the log transform and the 1e-5 constant [xcquinox/alec/networks.py:27--34]}{slides_code/p3_5_the_log_transform_and_the_1e_5_constant.txt}
\codenote{the meta-GGA coordinate ln((alpha + 1)/2) [xcquinox/alec/networks.py:48--80]}{slides_code/p3_6_the_meta_gga_coordinate_ln_alpha_1_2.txt}
\codenote{the exchange network on the doubled spin channel [xcquinox/alec/oneshot.py:465--537]}{slides_code/p3_7_the_exchange_network_on_the_doubled_spin.txt}
...
\codenote{tau from the live density matrix [xcquinox/alec/metagga.py:115--139]}{slides_code/p4_1_tau_from_the_live_density_matrix.txt}
\codenote{the smooth positive part [xcquinox/alec/metagga.py:142--152]}{slides_code/p4_2_the_smooth_positive_part.txt}
\codenote{alpha = (tau - tau\_W) / tau\_unif [xcquinox/alec/metagga.py:163--274]}{slides_code/p4_3_alpha_tau_tau_w_tau_unif.txt}
\codenote{the alpha descriptor of the network input [xcquinox/alec/descriptors.py:432--472]}{slides_code/p4_4_the_alpha_descriptor_of_the_network_inpu.txt}
\codenote{the cusp pair x\_4, x\_5 [xcquinox/alec/descriptors.py:225--258]}{slides_code/p4_5_the_cusp_pair_x_4_x_5.txt}
...
\codenote{the bounded map L\_lambda [xcquinox/alec/networks.py:129--169]}{slides_code/p5_1_the_bounded_map_l_lambda.txt}
\codenote{the MLP, GELU, the attention block after the first hidden layer, the gate and the output [xcquinox/alec/networks.py:366--405]}{slides_code/p5_2_the_mlp_gelu_the_attention_block_after_t.txt}
\codenote{the network construction and the zero-initialized last layer [xcquinox/alec/networks.py:283--300]}{slides_code/p5_3_the_network_construction_and_the_zero_in.txt}
\codenote{the exchange and correlation energy densities (LDA and PW92 factors) [xcquinox/alec/models.py:175--215]}{slides_code/p5_4_the_exchange_and_correlation_energy_dens.txt}
\codenote{the spin-scaled exchange energy (Oliver and Perdew) [xcquinox/alec/oneshot.py:465--537]}{slides_code/p5_5_the_spin_scaled_exchange_energy_oliver_a.txt}
\codenote{the self-attention block [xcquinox/net.py:50--136]}{slides_code/p5_6_the_self_attention_block.txt}
...
\begin{frame}{1. Model: the architectures}
  ...
  \scriptsize
  \begin{itemize}
    \item Inputs: $F_x$ from $x_s$, $F_c$ from $x_0, x_1, x_s$; the cusp architectures add $x_4, x_5$ to both, the meta-GGA ones $x_\alpha$ as well, the rung-3.5 ones their occupancy columns. The arms' cells carry the run's tag on the same axis: deep\_3x16 [25 cycles], deep\_3x16 [dpyscf parity].
...
\codenote{the architecture record [xcquinox/alec/config.py:103--159]}{slides_code/p6_1_the_architecture_record.txt}
\codenote{the registry entries shallow, shallow\_attn, medium and medium\_attn (shown deep\_2x8, deep\_attn\_2x8, deep\_3x16, deep\_attn\_3x16) [xcquinox/alec/config.py:512--515]}{slides_code/p6_2_the_registry_entries_shallow_shallow_att.txt}
\codenote{the registry entries deep\_3x16, deep\_attn\_3x16, deep\_cusp\_3x16 (shown deep0\_*) [xcquinox/alec/config.py:579--592]}{slides_code/p6_3_the_registry_entries_deep_3x16_deep_attn.txt}
\codenote{the registry entry deep\_cusp\_mgga\_3x16 [xcquinox/alec/config.py:691--695]}{slides_code/p6_4_the_registry_entry_deep_cusp_mgga_3x16.txt}
\codenote{from\_spec: the fields an entry sets [xcquinox/alec/config.py:385--470]}{slides_code/p6_5_from_spec_the_fields_an_entry_sets.txt}
...
\codenote{the 21 atomization points (names, spins, charges, references) [xcquinox/alec/dfs\_pool.py:106--225]}{slides_code/p7_1_the_21_atomization_points_names_spins_ch.txt}
\codenote{the three BH76 reaction points [xcquinox/alec/dfs\_pool.py:308--397]}{slides_code/p7_2_the_three_bh76_reaction_points.txt}
\codenote{the two ionization points [xcquinox/alec/dfs\_pool.py:427--466]}{slides_code/p7_3_the_two_ionization_points.txt}
\codenote{the H and Li anchors [xcquinox/alec/dfs\_pool.py:472--477]}{slides_code/p7_4_the_h_and_li_anchors.txt}
\codenote{the pool assembly [xcquinox/alec/dfs\_pool.py:547--639]}{slides_code/p7_5_the_pool_assembly.txt}
\codenote{the 26 points and their species [xcquinox/alec/training\_points.py:347--436]}{slides_code/p7_6_the_26_points_and_their_species.txt}
...
\codenote{the descriptor triple (rho\^{}(1/3), s, alpha) and the clip to [0, 100] [xcquinox/alec/subset\_selection.py:81--119]}{slides_code/p8_1_the_descriptor_triple_rho_1_3_s_alpha_an.txt}
\codenote{one PBE SCF per species at def2-svp, grid level 1 [xcquinox/alec/subset\_selection.py:375--406]}{slides_code/p8_2_one_pbe_scf_per_species_at_def2_svp_grid.txt}
\codenote{a point's sample is the concatenation over its species [xcquinox/alec/subset\_selection.py:409--445]}{slides_code/p8_3_a_point_s_sample_is_the_concatenation_ov.txt}
\codenote{the reference histograms: 200 bins between the 0.1 and 99.9 percentiles [xcquinox/alec/subset\_selection.py:448--469]}{slides_code/p8_4_the_reference_histograms_200_bins_betwee.txt}
\codenote{binning with the shared edges and the mass function [xcquinox/alec/subset\_selection.py:175--193]}{slides_code/p8_5_binning_with_the_shared_edges_and_the_ma.txt}
\codenote{binning with the shared edges [xcquinox/alec/subset\_selection.py:248--259]}{slides_code/p8_6_binning_with_the_shared_edges.txt}
...
\codenote{the probability floor 1e-12 [xcquinox/alec/subset\_selection.py:54--54]}{slides_code/p9_1_the_probability_floor_1e_12.txt}
\codenote{the Kullback-Leibler term [xcquinox/alec/subset\_selection.py:196--210]}{slides_code/p9_2_the_kullback_leibler_term.txt}
\codenote{the Jensen-Shannon divergence over the three marginals [xcquinox/alec/subset\_selection.py:213--245]}{slides_code/p9_3_the_jensen_shannon_divergence_over_the_t.txt}
\codenote{the exhaustive search over C(26, r) [xcquinox/alec/subset\_selection.py:472--688]}{slides_code/p9_4_the_exhaustive_search_over_c_26_r.txt}
...
\codenote{the pre-training systems: the DFS inventory and the pool atoms [xcquinox/alec/pretrain\_data\_gen.py:334--363]}{slides_code/p11_1_the_pre_training_systems_the_dfs_invento.txt}
\codenote{the pool atoms [xcquinox/alec/pretrain\_data\_gen.py:214--240]}{slides_code/p11_2_the_pool_atoms.txt}
\codenote{the exchange rows per spin channel at the doubled density [xcquinox/alec/pretrain\_data\_gen.py:379--479]}{slides_code/p11_3_the_exchange_rows_per_spin_channel_at_th.txt}
\codenote{the pointwise targets F\_parent - 1 [xcquinox/alec/pretrain\_data\_gen.py:981--1044]}{slides_code/p11_4_the_pointwise_targets_f_parent_1.txt}
\codenote{the synthetic (r\_s, s, alpha) mesh at 30 percent of the weight [xcquinox/alec/pretrain\_data\_gen.py:1068--1140]}{slides_code/p11_5_the_synthetic_r_s_s_alpha_mesh_at_30_per.txt}
\codenote{the integration weights abs(n eps\_LDA) w\_grid [xcquinox/alec/pretrain.py:104--167]}{slides_code/p11_6_the_integration_weights_abs_n_eps_lda_w.txt}
\codenote{the objective: pointwise term plus energy term [xcquinox/alec/pretrain.py:256--341]}{slides_code/p11_7_the_objective_pointwise_term_plus_energy.txt}
\codenote{the learning-rate schedule [xcquinox/alec/pretrain.py:1133--1208]}{slides_code/p11_8_the_learning_rate_schedule.txt}
\codenote{Adam with the global-norm clip [xcquinox/alec/pretrain.py:1211--1236]}{slides_code/p11_9_adam_with_the_global_norm_clip.txt}
\codenote{the loop: validation every validate\_every steps, patience, the best model kept [xcquinox/alec/pretrain.py:740--826]}{slides_code/p11_10_the_loop_validation_every_validate_every.txt}
...
\begin{frame}{3. Pre-training: the loss curves}
  ...
  \begin{column}{0.5\linewidth}
    ...
    \scriptsize
    \begin{itemize}
      \item Pointwise residual per step, exchange (left) and correlation (right); the recurring bursts from step 4000 to 8000 on are a property of the fit, not of the validation, which reloads nothing.
...
\codenote{the five channels and their assembly [xcquinox/alec/losses.py:1336--1417]}{slides_code/p15_1_the_five_channels_and_their_assembly.txt}
\codenote{the fixed channel weights 1, 1, 1, 1, 20 [xcquinox/alec/train.py:1829--1835]}{slides_code/p15_2_the_fixed_channel_weights_1_1_1_1_20.txt}
\codenote{the reaction residual (BH76 barriers, W4-11 atomizations as reactions) [xcquinox/alec/losses.py:530--578]}{slides_code/p15_3_the_reaction_residual_bh76_barriers_w4_1.txt}
\codenote{the BH76 channel [xcquinox/alec/losses.py:1282--1310]}{slides_code/p15_4_the_bh76_channel.txt}
\codenote{the ionization channel [xcquinox/alec/losses.py:581--605]}{slides_code/p15_5_the_ionization_channel.txt}
\codenote{the atom anchors: relative squared error at weight 0.01 [xcquinox/alec/losses.py:223--243]}{slides_code/p15_6_the_atom_anchors_relative_squared_error.txt}
\codenote{the atomization channel with the network's own atoms [xcquinox/alec/losses.py:246--273]}{slides_code/p15_7_the_atomization_channel_with_the_network.txt}
\codenote{the potential channel: the Frobenius residual over n\_AO\^{}2 [xcquinox/alec/losses.py:408--483]}{slides_code/p15_8_the_potential_channel_the_frobenius_resi.txt}
\codenote{the density channel per electron [xcquinox/alec/losses.py:366--405]}{slides_code/p15_9_the_density_channel_per_electron.txt}
\codenote{the convergence-tail weights (t/(N-1))\^{}2 [xcquinox/alec/oneshot.py:632--654]}{slides_code/p15_10_the_convergence_tail_weights_t_n_1_2.txt}
\codenote{one optimizer step per training group per epoch [xcquinox/alec/train.py:2001--2061]}{slides_code/p15_11_one_optimizer_step_per_training_group_pe.txt}
\codenote{the group's scoped loss [xcquinox/alec/train.py:1919--1965]}{slides_code/p15_12_the_group_s_scoped_loss.txt}
...
\begin{frame}{4. In-sample: the training losses (deep\_3x16)}
  ...
  \scriptsize
  \begin{itemize}
    \item SCF: 3 cycles from the converged PBE density, DFS mixing $D_{t+1} = (1 - a_t) D_t + a_t D^{\rm out}_t$, $a_t = 0.3^{t} + 0.3$ [DFS21 SI], gradients through every cycle, the last mixed density scored. AdamW $10^{-3} \to 10^{-5}$ over the second half, weight decay $10^{-4}$, clip 1.0, 200 epochs, validation MAE on 35 reactions every 25 epochs. The arms: 25 cycles, 100 epochs, checks every 10; the parity arm under the Letter's weights (reactions 0.01, no potential term) and a plateau schedule at $10^{-4}$.
    \item The reaction channel falls in every cell, by 2.3x (the parity arm at 7, trained at weight 0.01) to 188x (deep\_attn\_3x16 at 2) from two points upward and by 24x to 2223x in the one-point cells; the density channel by 1.15x to 4.6x, both settled within 25 epochs. The potential channel, absent from the DFS objective, rises in 43 of the 64 cells that carry it (deep\_3x16 at 18: 3.9e-5 to 4.3e-5), falls in 9 (every one-point cell; deep\_attn\_3x16 at 2, 15 and 18) and is flat in 12.
    \item Validation MAE: the 2-to-6-point cells of deep\_3x16, deep0\_3x16 and deep\_2x8 rise after the first check (deep\_3x16 at 2: 11.7 to 32.7 kcal/mol, best at epoch 25); the cells from seven points hold 4.7 to 11.6 kcal/mol; the small cells of deep\_attn\_3x16 fall (37 to 7 kcal/mol), those of deep\_attn\_2x8 fall at 3, 4 and 6 and stay near 29 at 2 and 5.
  \end{itemize}
\end{frame}
...
\codenote{the SCF: three cycles, the DFS mixing schedule, the tail loss [hpcjobs/configs/dfs\_step7.dfs6311\_grid3\_v7g1\_size.yaml:131--140]}{slides_code/p16_1_the_scf_three_cycles_the_dfs_mixing_sche.txt}
\codenote{the mixing schedule a\_t = 0.3\^{}t + 0.3 [xcquinox/alec/solver.py:303--358]}{slides_code/p16_2_the_mixing_schedule_a_t_0_3_t_0_3.txt}
\codenote{the PBE seed [xcquinox/alec/solver.py:88--125]}{slides_code/p16_3_the_pbe_seed.txt}
\codenote{the SCF cycle: the mixed density scored, gradients through every cycle [xcquinox/alec/solver\_manual.py:404--463]}{slides_code/p16_4_the_scf_cycle_the_mixed_density_scored_g.txt}
\codenote{the cycles as a scan (gradients through every cycle) [xcquinox/alec/solver\_manual.py:263--289]}{slides_code/p16_5_the_cycles_as_a_scan_gradients_through_e.txt}
\codenote{AdamW, the linear decay over the second half, weight decay, the clip [xcquinox/alec/train.py:112--202]}{slides_code/p16_6_adamw_the_linear_decay_over_the_second_h.txt}
\codenote{the hyperparameters of the run (200 epochs, 1e-3 to 1e-5, weight decay 1e-4, clip 1.0, validation every 25) [hpcjobs/configs/dfs\_step7.dfs6311\_grid3\_v7g1\_size.yaml:153--183]}{slides_code/p16_7_the_hyperparameters_of_the_run_200_epoch.txt}
\codenote{the validation slice [xcquinox/alec/train.py:745--817]}{slides_code/p16_8_the_validation_slice.txt}
\codenote{the validation reaction-energy MAE [xcquinox/alec/train.py:820--862]}{slides_code/p16_9_the_validation_reaction_energy_mae.txt}
\codenote{the validation-best tracker [xcquinox/alec/train.py:682--742]}{slides_code/p16_10_the_validation_best_tracker.txt}
\codenote{the validation-best checkpoint among the three saved [xcquinox/alec/train.py:1017--1052]}{slides_code/p16_11_the_validation_best_checkpoint_among_the.txt}
...
\begin{frame}{4. In-sample: the trained enhancement factors}
  ...
  \scriptsize
  \begin{itemize}
    \item Exchange, every architecture and subset: the trained $F_x$ is below PBE by 0.002 to 0.06 near $s = 0.8$ and above it from $s = 1.0$ to 1.7, by up to 0.18 (deep\_3x16), 0.13 (deep\_attn\_3x16), 0.14 (deep0\_3x16), 0.19 (deep0\_attn\_3x16), 0.08 (deep\_2x8), 0.19 (deep\_attn\_2x8) and 0.13 (both arms) at $s = 1.9$ to 3.4 (deep\_attn\_3x16 at seven excepted, whose largest deviation is its dip at $s = 1.1$); the one-molecule cells of deep\_3x16 and deep0\_3x16 move least at $s = 0.8$.
    \item Correlation at $r_s = 2$: the one-molecule cells fall from 1 to 0.16 by $s = 2$ and to 0 beyond; the other cells run from 0.10 (the parity cells, at PBE) to 1.3 up to $s = 2$ (PBE falls to 0.02 by $s = 3$), then split: deep\_3x16 at 2, 3, 5, 6, 15, 18, 26 decays to 0.1 to 0.6 by $s = 6$ while 4, 7 and 12 rise to 1.1 to 1.3; every deep\_attn\_3x16 cell but the one-molecule one rises above 1 (up to 1.9 at $s = 6$), the eighteen-point cell falling back to 0.8; deep\_2x8's cells from seven points rise to 1.0 to 1.3 while its small cells decay to 0.2 to 0.4; the parity arm's $F_c$ stays within 0.08 of PBE on every drawn slice.
  \end{itemize}
\end{frame}
...
\begin{frame}{4. In-sample: energy and density in DFS units on the training reactions}
  ...
  \begin{itemize}
    ...
    \item All 66 cells are below PBE on $\mathcal{ED}$ over their own reactions: training WTMAD-2 0.00 to 5.4 kcal/mol against 5.67 on the union of the training reactions, deep\_attn\_3x16 0.05 to 2.45, deep0\_attn\_3x16 0.05 to 3.23, the parity arm 4.5 and 5.4. The grid-RMSE density of the trained molecules is below PBE in every cell (NN/PBE 0.72 to 0.97 deep\_3x16, 0.57 to 0.76 deep\_attn\_3x16, 0.68 to 0.93 deep0\_3x16, 0.64 to 0.91 deep0\_attn\_3x16, 0.65 to 0.92 deep\_2x8, 0.71 to 0.86 deep\_attn\_2x8, 0.65 to 0.83 the arms); the per-electron $\varepsilon_n$ of deep\_3x16 is above the pooled PBE value from 2 to 18 points.
  \end{itemize}
\end{frame}
...
\codenote{the full pools (76 BH76, 140 W4-11) before the validation split [xcquinox/alec/full\_benchmark\_pools.py:516--543]}{slides_code/p19_1_the_full_pools_76_bh76_140_w4_11_before.txt}
\codenote{the validation slice, split by reaction identity [xcquinox/alec/eval\_holdout.py:204--245]}{slides_code/p19_2_the_validation_slice_split_by_reaction_i.txt}
\codenote{the strict held-out filter [xcquinox/alec/eval\_holdout.py:173--201]}{slides_code/p19_3_the_strict_held_out_filter.txt}
\codenote{the cell's trained reactions removed [xcquinox/alec/eval\_holdout.py:283--338]}{slides_code/p19_4_the_cell_s_trained_reactions_removed.txt}
\codenote{the energy legs average one term per reaction identity [xcquinox/alec/eval\_holdout.py:402--442]}{slides_code/p19_5_the_energy_legs_average_one_term_per_rea.txt}
\codenote{eps\_n per electron [xcquinox/alec/evaluation.py:196--218]}{slides_code/p19_6_eps_n_per_electron.txt}
\codenote{the grid RMSE [xcquinox/alec/evaluation.py:293--320]}{slides_code/p19_7_the_grid_rmse.txt}
\codenote{WTMAD-2 with the GMTKN55 scale [notebooks/analysis/make\_ablation\_arch\_figure.py:3824--3857]}{slides_code/p19_8_wtmad_2_with_the_gmtkn55_scale.txt}
\codenote{the harmonic mean [notebooks/analysis/make\_ablation\_arch\_figure.py:4835--4841]}{slides_code/p19_9_the_harmonic_mean.txt}
\codenote{the self-calibrated gamma = E\_PBE / D\_PBE [notebooks/analysis/make\_ablation\_arch\_figure.py:4868--4943]}{slides_code/p19_10_the_self_calibrated_gamma_e_pbe_d_pbe.txt}
\codenote{the DFS gamma 1084.87 [notebooks/analysis/make\_ablation\_arch\_figure.py:4952--4975]}{slides_code/p19_11_the_dfs_gamma_1084_87.txt}
...
\begin{frame}{5. Held-out: per-cell results, combined leg, DFS units, the 3x16 families [holdout\_by\_pool\_3x3\_eps.csv]}
  ...
  \scriptsize
  \begin{itemize}
    \item E in kcal/mol (2-subset WTMAD-2), eps per electron, ED under $\gamma = 1084.87$ kcal/mol; E PBE and eps PBE are the pooled values, ED PBE the cell-slice value. $\Delta$ED = ED NN $-$ ED PBE: \textbf{bold, negative} marks a cell below PBE (26 of these 40 cells; the 2x8 pair and the arms on the next slide).
  \end{itemize}
\end{frame}
...
\begin{frame}{5. Held-out: per-cell results, combined leg, DFS units, the 2x8 pair and the arms [holdout\_by\_pool\_3x3\_eps.csv]}
  \begin{center}\tiny\setlength{\tabcolsep}{2.2pt}
  \begin{tabular}{llrrrrrrr|llrrrrrrr}
  \toprule
  Arch & $r$ & E NN & E PBE & eps NN & eps PBE & ED NN & ED PBE & $\Delta$ED & Arch & $r$ & E NN & E PBE & eps NN & eps PBE & ED NN & ED PBE & $\Delta$ED \\ \midrule
  ...
  deep\_3x16 [25 cycles] & 7 & 6.92 & 8.92 & 0.00972 & 0.00923 & 8.36 & 9.49 & \textbf{-1.13} &  & & & & & & & &  \\
  deep\_3x16 [25 cycles] & 12 & 7.17 & 8.92 & 0.00983 & 0.00923 & 8.57 & 9.56 & \textbf{-0.99} &  & & & & & & & &  \\
  \bottomrule
  \end{tabular}
  \end{center}
  \scriptsize
  \begin{itemize}
    \item The same columns; \textbf{bold, negative} marks a cell below PBE: 15 of these 24 cells, 41 of the 64 over the two slides. deep\_2x8 is below PBE at every size but 3 to 6, where its energy leg is within 1.0 kcal/mol of PBE and its density leg 22 to 25 percent above; both arms are below PBE at 7 and 12.
    \item Verdicts within about 10 percent of PBE on a leg depend on the leg and the units: under the plain-MAE leg deep\_attn\_3x16 at 2, 3, 5 and 6, deep0\_3x16 at 3 and deep0\_attn\_3x16 at 6 flip; under self-calibrated grid-RMSE units deep\_2x8 at 3 to 6, deep\_attn\_3x16 at 2 and deep0\_3x16 at 3 flip (holdout\_ed\_combined.csv). The other 54 cells carry the same verdict under every choice.
  \end{itemize}
\end{frame}
\slidenote{The remaining 24 evaluated cells in the same columns: the two 2x8 networks and the two arms of the density program (the tagged deep\_3x16 cells trained under 25 SCF cycles and under the dpyscf-parity protocol). Fifteen of them beat PBE: deep\_2x8 at 1, 2 and from 7 points on, deep\_attn\_2x8 at 1, 7, 12 and 15, and both arms at 7 and 12; with the 26 of the previous slide, 41 of the 64 evaluated cells. \textbf{Second bullet:} the verdict of a cell whose $\Delta$ED is within a few tenths of zero can change when the energy leg is the plain mean absolute error instead of WTMAD-2, or when the density leg is the grid RMSE with a self-calibrated $\gamma$ instead of $\varepsilon_n$ with the DFS $\gamma$; the deep\_attn\_3x16 cells at 2, 3, 5 and 6, deep0\_3x16 at 3, deep0\_attn\_3x16 at 6 and deep\_2x8 at 3 to 6 are such cases. The deep\_3x16, deep\_attn\_2x8 and arm verdicts do not depend on those choices.}
...
\begin{frame}{6. Pending work}
  \small
  \begin{itemize}
    \item Cells running or queued: deep\_attn\_3x16 at 26 (stopped by the 48 h wall, relaunched from its resume checkpoint), deep\_attn\_2x8 at 26, deep0\_attn\_3x16 at 15 to 26, deep0\_cusp\_3x16 at every subset, the arms at 15 to 26. Two evaluated cells (deep\_attn\_2x8 at 18, deep\_3x16 [25 cycles] at 15) await re-evaluation: their passes ran while the T1 backfill was rewriting the reference files with a key the reference reader did not accept, so every reference was refused and the tables held no reaction; the corrected reader (the key accepted; an evaluation that reads no species refused instead of written) is committed and is deployed with the re-runs in a later cluster session.
    ...
    \item Converged-SCF re-evaluation: one cell-pass (deep\_3x16 at 1, final checkpoint, 214/214 converged) took about 13 h of the 24 h job; the campaign at two checkpoints is about 1700 node-hours, so the program's shape is a decision still open. The T1 diagnostics landed (203 species, threshold 0.02); the model-free tail-excluded views are rendered from them.
    \item The two arms on deep\_3x16 (25 SCF cycles, arm A; the dpyscf-parity protocol, arm B: no convergence freeze, the executed first-mix index, the randomized atomic/PBE seed, Adam with the plateau schedule, the DFS L2 and channel weights): 7 and 12 in the figures; 15 to 26 running or queued.
