...
\citep[their Theorem~3.1, eqs.~26--27]{LiebOxford1981}; \citet{PerdewBurkeErnzerhof1996}
...
reference: Chakravorty 1993's Table~VIII covers 3- through
10-electron CAS-IP correlation energies (extended to 11--18 electrons
in Table~IX), and the 2-electron correlation energy is taken from a
...
\citet{Kepp2017} (footnote~2) and traces to \citet{CruzLamBurke1998}; the broader
...
of \citet[Table~2 and \S 5.2]{ChenGradNorm2018}; the same paper also
uses $\alpha = 0.12$ for a synthetic 2-task regression toy problem
(\S 4 / Fig.~2), so the value is task-specific and not asserted
