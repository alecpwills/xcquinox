...
def test_blocks_are_class_identical_across_modules():
    """Test 14: pipeline re-imports xcquinox.net.SelfAttentionBlock; class
    identity must hold (not a stale duplicate import).
    """
    from xcquinox.pipeline import networks as pipeline_networks
    import xcquinox.net as legacy_net
    assert pipeline_networks._xnet.SelfAttentionBlock is legacy_net.SelfAttentionBlock
