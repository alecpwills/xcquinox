...
from xcquinox.pipeline.checkpoint_class import (ClassRecordStale,
                                            ModelClassMismatch,
                                            class_record_path,
...
#:   legacy_package   ``xcquinox.net`` / ``xcquinox.xc``. Those models are not
#:                    AlecGGAModel and carry neither the anchor nor the
#:                    descriptor coordinates, so there is no class for a
#:                    record to state.
#:
...
ALLOWED = {
    "xcquinox/pipeline/checkpoint_class.py": "library_reader",
    "xcquinox/pipeline/evaluation.py": "library_reader",
    "xcquinox/pipeline/eval_holdout.py": "library_reader",
    "xcquinox/pipeline/train.py": "library_reader",
    "xcquinox/pipeline/pretrain.py": "library_pretrain",
    "xcquinox/pipeline/cluster/fidelity.py": "pretrain_reader",
    "notebooks/_build_gga_training_pipeline_notebook.py": "pretrain_reader",
    "notebooks/_build_gga_training_scf_solvers_notebook.py": "pretrain_reader",
    "notebooks/_build_gga_training_anchor_transfer_notebook.py": "pretrain_reader",
    "tools/analysis/constraint_pretrain_gmtkn55_demo.py": "pretrain_reader",
    "tools/analysis/mgga_diagnosis_evidence.py": "pretrain_reader",
...
def test_every_allowed_pretrain_reader_still_reads_only_pretrain_networks():
    ...
    ``_build_gga_training_anchor_transfer_notebook.py``'s "canonical pattern" comment -- naming a
