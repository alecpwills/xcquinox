...
from xcquinox.pipeline.config import MoleculeSpec, get_architecture
from xcquinox.pipeline.data import precompute_fixed_density_data
from xcquinox.pipeline.models import AlecGGAModel
from xcquinox.pipeline.solver import SolverConfig, SolverBackend, SolverMode, run_scf
...
def test_df_scf_energy_matches_full_eri_uks():
    ...
    Regression for the review finding that the open-shell DF Coulomb build,
