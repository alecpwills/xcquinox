"""Tests for the deferred-eval submitter (xcquinox.pipeline.cluster._submit_eval).
...
from xcquinox.pipeline.cluster import _submit_eval as SE
...
_EXAMPLE = "xcquinox/pipeline/cluster/examples/grid_step7.yaml"
