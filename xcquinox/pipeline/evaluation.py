"""xcquinox.pipeline.evaluation -- Metric ABC, 4 built-in metrics, run_test."""
import abc
import os
import csv
import json
...
from xcquinox.pipeline.config import TestSpec, ArchitectureConfig
...
class SCFConvergenceMetric(Metric):
    ...
    def compute(self, model, mol_data, solver_config=None):
        ...
        from xcquinox.pipeline.solver import SolverMode, run_scf
