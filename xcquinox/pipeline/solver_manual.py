"""xcquinox.pipeline.solver_manual: Manual JAX-native SCF backend.
...
def _resolve_coulomb(config: SolverConfig, mol_data: dict):
    ...
    if use_df:
        from xcquinox.pipeline.df_jk import compute_j_df
...
def _build_criterion(config: SolverConfig):
    ...
    """
    from xcquinox.pipeline.solver import CRITERION_REGISTRY
