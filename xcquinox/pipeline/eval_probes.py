...
- Haunschild2012 : Haunschild & Klopper, J. Chem. Phys. 136,
  ...
  The table it was parsed into is the package data file (kJ/mol; column
  ``E``) ``xcquinox/data/haunschild_g2/g2_97.csv``, beside the trajectory
  the probe geometries are read from.
...
# ``xcquinox/data/haunschild_g2/g2_97.traj``.  The "spin" entry
...
# ``BH76/.resRC``: see data/gmtkn55/PROVENANCE.md). A
...
# the rest of the pipeline stack, frozen-core CCSD(T)(F12), converted from
...
def _g297_traj_path() -> Path:
    """The G2/97 ASE trajectory, package data under xcquinox/data/haunschild_g2 (the same
    file dfs_pool reads)."""
