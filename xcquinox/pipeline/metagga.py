...
Like the rung-3.5 occupancy (:mod:`xcquinox.pipeline.rung35`), ``tau`` is a **linear
...
:func:`xcquinox.pipeline.subset_selection.compute_descriptor_triple` keeps the hard
...
# so the XC-energy change is <=1e-9 relative.
#
...
def compute_alpha(rho, sigma, tau) -> jnp.ndarray:
    ...
    # test for the bh76:HLi failure, which reaches
