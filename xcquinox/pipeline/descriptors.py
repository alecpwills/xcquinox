"""xcquinox.pipeline.descriptors: Descriptor ABC, registry, and concrete descriptors.
...
from xcquinox.pipeline.rung35 import (DEFAULT_RUNG35_ALPHA,
...
class DMStatisticsDescriptor(Descriptor):
    ...
    the descriptor specification of 2026-08-09.
...
class DMRung35Descriptor(Descriptor):
    ...
    See :mod:`xcquinox.pipeline.rung35` for the projected-AO overlap ``A_mu(r)`` (a
...
class MetaGGAAlphaDescriptor(Descriptor):
    ...
    See :mod:`xcquinox.pipeline.metagga`.
    """
