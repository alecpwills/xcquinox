...
def _route_jax_env():
    ...
    ``python -m xcquinox.pipeline.cluster._datagen`` runs ``xcquinox/__init__``
...
def main(argv=None) -> int:
    ...
    from xcquinox.pipeline import pretrain_data_gen as _pdg
    ...
    # it is granted: False is the generator's own default, so a configuration that
