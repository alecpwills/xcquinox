"""xcquinox.pipeline.cluster._submit_eval -- deferred-eval submitter.
...
launcher runs this module::
    ...
    python -m xcquinox.pipeline.cluster._submit_eval <RUN_DIR>
...
exposes it as ``python -m xcquinox.pipeline.cluster submit-eval <RUN_DIR>``).
...
def submit_deferred_eval(run_dir: str, *, force: bool = False) -> dict:
    ...
    if not os.path.isfile(eval_path):
        ...
        from xcquinox.pipeline.cluster.submit import render_sbatch
