...
is this: a scoping error was made by reading the
...
Usage::
    ...
    python -m xcquinox.pipeline.cluster.validate_run <run_dir> [--config PATH]
...
from xcquinox.pipeline.cluster.fidelity import (CERTIFICATE_FILENAME,
                                            ...
                                            show_identity)
from xcquinox.pipeline.cluster._eval_one_spec import (_load_spec, _read_width,
                                                  _spec_path)
