"""xcquinox.pipeline.cluster.inputs: input-artifact staging for the HPC harness.
...
adapts :func:`xcquinox.pipeline.cluster.spec_builder.build_training_specs` to
consume this format.
...
from xcquinox.pipeline import external_refs as _external_refs
from xcquinox.pipeline import pretrain_data_gen as _pretrain_data_gen
from xcquinox.pipeline.training_points import build_dfs_pool_points, _atom_anchor_atoms
from xcquinox.pipeline.cluster.grid_config import GridConfig, expand_grid
...
def _ledger_scoped_species(points, subset_ledger, *, extra_atoms=()):
    ...
    from xcquinox.pipeline.training_points import species_union_from_points
...
class StagedInputs:
    ...
    subset_ledger : dict
        ...
        :func:`xcquinox.pipeline.cluster.spec_builder.build_training_specs` (the
...
def _stage_validation_slice(cfg: GridConfig, run_dir: str):
    ...
    :func:`xcquinox.pipeline.data.precompute_fixed_density_data` (via
