...
the pipeline subpackage and extends it with a Jensen-Shannon divergence
...
# HB and PT water-dimer geometries verbatim from the binning notebook of the
# 2024 exploratory work (cell 20).
...
def extract_descriptors(
    ...
    *,
    ...
    _build_gga_training_anchor_transfer_notebook.py:528-532.
    """
