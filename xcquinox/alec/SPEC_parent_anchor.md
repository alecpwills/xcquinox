...
`s`, to round-off in the implementation (within 5.2e-16 relative for `lambda` in {0.5, 2,
10}, the recomputed `s` differing in its last bit on a few rows of any row set); the spin
