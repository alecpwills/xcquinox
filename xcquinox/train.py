...
class Pretrainer(eqx.Module):
    ...
    def __init__(self, model, optim, inputs, ref, loss, steps=1000, print_every=100):
        ...
        :type ref: jnp.array
        :param loss: A loss function decorated with @eqx.filter_value_and_grad
        :type loss: Callable
