...
the tail-gradient freeze was removed from ``compute_alpha``,
the clip bounds the VALUE only, and the counter-evidence on record
...
from xcquinox.pipeline.config import ARCHITECTURES, MoleculeSpec
...
from xcquinox.pipeline.solver import (FeaturePolicy, SolverBackend, SolverConfig,
                                  SolverMode, run_scf)
import xcquinox.pipeline.oneshot as oneshot
