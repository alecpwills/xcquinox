...
Usage::
    ...
    python tools/analysis/plot_subset_jsd.py \\
        ...
        --outdir reports/v7/figures_dfs_step7_v7_subsets
"""
...
from xcquinox.pipeline.training_points import build_dfs_pool_points  # noqa: E402
...
DEFAULT_OUTDIR = _REPO / "reports" / "v7" / "figures_dfs_step7_v7_subsets"
