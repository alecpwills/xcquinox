...
Usage:
  python tools/analysis/anchored_vs_unanchored_fx_fc.py [--outdir DIR]
"""
...
from xcquinox.pipeline.arch_names import split_tag  # noqa: E402
...
def read_curve(path: Path, arch: str, channel: str, *,
    ...
    (the ``protocol`` column the trained curve files carry),
