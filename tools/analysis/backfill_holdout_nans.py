...
``xcquinox.pipeline.workers.eval_holdout_worker`` subprocess over the NaN
...
Usage (from the repo root):
    ...
    python tools/analysis/backfill_holdout_nans.py <run_dir> \
...
def run_worker(run_dir: Path, spec_idx: int, names: Sequence[str],
    ...
    cmd = [sys.executable, "-m",
           "xcquinox.pipeline.workers.eval_holdout_worker",
