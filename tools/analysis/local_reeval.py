...
# used by tools/analysis/multimode_constraint_eval.py.
import os
...
# primitives + JSON/CSV writers were lifted to ``xcquinox.pipeline.eval_holdout``
...
def run_one_spec(
    ...
    *,
    ...
    # drivers refuse it, rather than written as a table of NaN
...
def run_auto(
    ...
    *,
    ...
    The PBE precompute cache in ``xcquinox.pipeline.data`` amortizes across all
