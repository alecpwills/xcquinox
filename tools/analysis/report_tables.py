...
the report): ``training_losses`` (the first and last five-epoch means of the
...
Usage:
    python tools/analysis/report_tables.py --splice REPORT.md SUMMARY.md
    python tools/analysis/report_tables.py --view <family view dir> --splice REPORT.md
"""
...
DEFAULT_FAMILY_DIR = _ROOT / "reports" / "v7" / "figures_dfs_step7_v7_family_val_best"
DEFAULT_EXCL_DIR = _ROOT / "reports" / "v7" / "figures_dfs_step7_v7_family_val_best_excl_tail"
...
# ---------------------------------------------------------------------------
# the training-log tables of Sec. 4.6: the cells' aux_log.pkl read
