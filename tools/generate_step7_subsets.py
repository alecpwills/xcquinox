...
functions (`xcquinox.pipeline.subset_selection` + `training_points`). Produces, per
...
Usage:
    python tools/generate_step7_subsets.py                 # both modes
    python tools/generate_step7_subsets.py --modes alpha_off
    STEP7_SUBSET_BATCH=65536 python tools/generate_step7_subsets.py
"""
...
from _build_gga_training_dfs_subsets_notebook import (  # noqa: E402
    SUBSET_SIZES, METRICS, SOLVERS, ARCH_NAME, LOSS_NAME,
)

from xcquinox.pipeline import subset_selection as ss  # noqa: E402
from xcquinox.pipeline.training_points import (  # noqa: E402
